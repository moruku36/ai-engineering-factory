...
| **Antigravity** | Unsupported (BLOCKED) | Native transport not implemented | Binary discovery is not a capability test; native and implicit fallback are refused. Select manual mode explicitly. See [PROJECT_STATE.md](../../PROJECT_STATE.md) for the hands-on capability audit conclusion. |
