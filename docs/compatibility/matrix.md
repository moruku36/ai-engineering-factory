...
| **OS** | Expected | macOS | Not in the CI matrix; the offline container boundary (`OfflineContainerRunner`) additionally requires a local Linux Docker daemon and is skipped on non-Linux platforms at runtime. |
